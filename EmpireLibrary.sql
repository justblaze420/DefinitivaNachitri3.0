...
INSERT INTO libros (nombre, autor, año_publicacion, stock, genero, fecha_pub, estado) VALUES
...
BEGIN
    INSERT INTO libros (nombre, autor, año_publicacion, stock, genero, fecha_pub, estado)
    VALUES (p_nombre, p_autor, p_año_publicacion, p_stock, p_genero, p_fecha_pub, p_estado);
END //
DELIMITER ;
